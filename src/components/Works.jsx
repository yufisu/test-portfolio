    ...
    <div className="my-work-page flex items-center h-screen max-sm:h-screen max-sm:flex-col ">
      <div className="work-left text-white flex-1 flex flex-col justify-center h-screen ml-24 max-sm:h-auto max-sm:ml-0 max-sm:p-5">
        <div className="work-title text-[3.5rem] mb-5 max-sm:mb-3 max-sm:mt-24 max-sm:flex max-sm:justify-center">
          ...
          <p className="font-['sf-thin-italic'] max-sm:w-auto max-sm:text-center w-auto">&lt;p&gt;You can see and analyze my work here. Every second I find in my spare time, I try to code new projects. Please note that these are not my designs, just the code.&lt;/p&gt;</p>
      </div>
